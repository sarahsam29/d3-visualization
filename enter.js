...
countries.sort((x,y) => y.Population - x.Population)
  ...
  d3.selectAll('svg#big-countries')
    ...
    .duration(1000)
    .attr('x', 130)
    .attr('y', (d, i) => i * 20) //creates gap between bars =  5 pixels
    .attr('height', 15) // controls height
    .attr('width', d => (d.Population / 1500) * 400) // controls width
    .style('fill', '#F08080')
